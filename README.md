...
nine skills and five read-only subagents: two reviewers (`gate-reviewer`,
`contract-red-team`) and three recon roles (`recon-locator`,
...
├── agents/                # five read-only roles: 2 reviewers + 3 recon

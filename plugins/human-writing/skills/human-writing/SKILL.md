...
This skill is based on Wikipedia's "Signs of AI writing" page (https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing), maintained by WikiProject AI Cleanup, whose text is available under CC BY-SA. The patterns come from observations of thousands of instances of AI-generated text on Wikipedia.

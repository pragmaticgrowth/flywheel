...
import { resolveProvider, resolveModel, DEFAULT_MODELS, DEEP_MODELS, FAST_MODELS, } from "../config.js";
import { runWithProvider } from "../providers/index.js";
import { buildResearchPrompt, buildResearchFastPrompt, buildReviewPrompt, buildExplorePrompt, buildArchitectPrompt, buildSilentScanPrompt, buildTypeCheckPrompt, buildAdversarialReviewPrompt, } from "../prompts/index.js";
...
const PRESETS = [
    {
        name: "do_research",
        description: "Deep web research — parallel search across web, Reddit, HN, docs. Returns structured findings with source citations and confidence assessment. Prompt includes grounding rules to prevent hallucinated sources.",
    ...
    },
    {
        ...
        description: "Quick research lookup — concise answer under 200 words with primary source and caveats. Uses the fastest/cheapest model. For thorough research use do_research.",
    ...
    {
        name: "do_silent_scan",
        description: "Silent failure scanner — finds swallowed errors, empty catches, ignored promises, missing error handling on I/O. Orders findings by production risk.",
    ...
    {
        name: "do_type_check",
        description: "TypeScript type design review — flags any leaks, unsafe casts, missing nullability, incorrect generics. Only reports types that could cause runtime errors.",
    ...
    },
    {
        ...
        description: "Adversarial review that challenges design choices, assumptions, and tradeoffs — not just code quality. Returns structured verdict with severity-rated findings.",

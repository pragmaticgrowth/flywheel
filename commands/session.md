...
allowed-tools: mcp__mcp-droid__do_session_continue, mcp__mcp-droid__do_session_list
---
...
- `continue <session_id> <prompt>`: Call `mcp__mcp-droid__do_session_continue` with the session_id and prompt
- `list`: Call `mcp__mcp-droid__do_session_list` with `scan_disk: true` for complete results
